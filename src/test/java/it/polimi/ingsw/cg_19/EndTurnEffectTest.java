...
/**
	...
	public void testExecuteEffect() {
		...
		Player player1 = new Player("",new PlayerToken(PlayerType.HUMAN,1));
		Player player2 = new Player("",new PlayerToken(PlayerType.ALIEN,1));

		// Both player located in source
		player1.setCurrentSector(source);
		source.addPlayer(player1);
		player2.setCurrentSector(source);
