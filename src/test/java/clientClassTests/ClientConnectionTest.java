...
public class ClientConnectionTest {
		...
		public void getRmiServiceNameTest() {
			clientConnection = new ClientConnection(0000, "dsafsafasf", "sadasd");
			assertEquals("sadasd", clientConnection.getRmiServiceName());
			clientConnection = new ClientConnection(0000, "dsafsafasf", "");
			assertEquals("", clientConnection.getRmiServiceName());
		}
	}
